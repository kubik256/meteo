...
const int UNIT_NO = 1; /* YOU CAN BUILD AS MANY UNITS AS YOU WANT, BUT ALWAYS INCRASE UNIT_NO */
const char* MQTT_SERVER = "############ MQTT address goes here ############";
const char* MQTT_USER = "############ MQTT name goes here ############";
const char* MQTT_PASS = "############ MQTT password goes here ############";
